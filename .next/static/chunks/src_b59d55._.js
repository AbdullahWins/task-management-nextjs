(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b59d55._.js", {
...
const taskSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        builder.addMatcher(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$store$2f$modules$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].endpoints.getTasks.matchFulfilled, (state, action)=>{
            state.tasks = action.payload.data;
            state.loading = false;
        });
        builder.addMatcher(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$store$2f$modules$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].endpoints.getTasks.matchPending, (state)=>{
            state.loading = true;
            state.error = null;
        });
        builder.addMatcher(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$store$2f$modules$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].endpoints.getTasks.matchRejected, (state, action)=>{
            state.loading = false;
...
_s(TaskCard, "0X2YyZNCUZSMrrd2Y1qhFaFte70=", false, function() {
    return [
...
_s(Tasks, "orJ/NIor+PX76bdCGCGiaO0AeYA=", false, function() {
    return [
...
"[project]/src/app/tasks/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_b59d55._.js.map